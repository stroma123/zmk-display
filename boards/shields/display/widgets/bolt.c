 ...
 *
 * Charging bolt glyph, 11x18, indexed 2-bit (depth independent).
 * Default palette draws a white bolt for the light-on-dark screen.
 */
...
#if IS_ENABLED(CONFIG_DISPLAY_WIDGET_INVERTED)
